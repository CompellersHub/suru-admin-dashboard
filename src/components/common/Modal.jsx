    ...
    >
      <div className='flex items-center justify-center min-h-screen pt-4 px-4  text-center sm:block sm:p-0'>
        ...
        <div
          ...
          className='inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle md:w-4/5 smmax-w-lg sm:w-full sm:p-6'
        >
